    ...
    <div>
      <div>
        <button
          ...
          onClick={handleClick}
        >
          Show Info Creating Unknown Escrows
        </button>
        <dialog id="my_modal_4" className="modal">
          <div className="modal-box w-11/12 max-w-5xl h-90 overflow-y-auto">
            <h3 className="font-bold text-lg">Creating Unknown Escrows</h3>
            <div className="py-4 text-xl">
              <p>
                In this step, we will Create Escrow for Unknown Parties. In
                escrow for unknown party, any one can participate in the escrow
                and pay for the described amount escrow and own the NFT.
                <br />
                <br />
                If you want to Check an Escrow Information, then <button className="font-semibold text-red-400" onClick={() => router.push('./getallactiveunknownescrow')}>Click Here</button>
              </p>
              <br />
              <br />
              <p>To create an escrow, We'll require these three fields</p>
              <br />
              <ul>
                <li>
...
export default CreateUnknownEscrowInfo;
