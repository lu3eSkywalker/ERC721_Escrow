...
const CreateEscrowForUnKnown = () => {
  ...
  const ABI = ["function createEscrowForUnknownParties(uint256, uint256) public"];
  ...
  async function createEscrow() {
    if (window.ethereum) {
      try {
        ...
        const createEscrowForNFT = await contract.createEscrowForUnknownParties(tokenId, price);
